...
figure();
%    replicate T so that it is same size as dZ
plot(repmat(T,1,size(dZ,2)), dZ,'-');
xlabel('Time (sec)');
ylabel('Approx. Tether Length (µm)');
title('Zrel: Particle height relative to refrence LUT');
